...
//      }
//    } ~
    path("peset") { // Path to return json
      post {
      ...
      withoutRequestTimeout {
        get {
          entity(as[String]) { json =>
            ...
            println("ServerID " + serverId.toString + ", call_id: " + callId.toString)
            respondWithHeaders(RawHeader("call_id", callId.toString), RawHeader("server_id", serverId.toString)) {
